...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    story:
      "Here all started. As a intern in 4Core Data Structure, this is a small/startup business which offer installation of CCTV cabling systems, im a part of creating a real web app using PHP Vanilla JS, no shortcuts, pure raw code. I've build a portfolio company website this is the hard part as a newbie — I need to Understand from the scratch on how to creating a backend, database queries, at server-side logic. But this internship is teaching me the foundational of web development until now, I Still value the experience and knowledge i gained from this work, even now while im using React and TypeScript. Sometimes, When I struggle in the new concept, I remember on how can i figure out these things back then. — with pure research, experimentation and also help of Stack Overflow HAHAHAHA.",
  },
];